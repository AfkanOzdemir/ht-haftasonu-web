...
const page = () => {
  return (
    <div className="w-full h-full overflow-hidden py-5 px-2 sm:px-5 relative pt-32">
      <div className="w-full h-full flex items-center justify-center after:absolute after:w-4/5 after:h-[400px] sm:after:w-[700px] sm:after:h-[700px] lg:after:w-[600px] lg:after:h-[600px] after:bg-cover after:bottom-0 lg:after:-bottom-[25rem]
